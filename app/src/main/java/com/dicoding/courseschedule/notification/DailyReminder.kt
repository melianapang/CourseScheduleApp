...
class DailyReminder : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        executeThread {
            ...
            val courses = repository?.getTodaySchedule(day)
    ...
    private fun showNotification(context: Context, content: List<Course>) {
        ...
        val resultPendingIntent = PendingIntent.getActivity(context, ID_REPEATING, resultIntent, PendingIntent.FLAG_UPDATE_CURRENT)
